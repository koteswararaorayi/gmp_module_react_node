...
const ERROR_CODES = {
  ...
  ERR_DUPLICATE_WAREHOUSE_NAME: "ERR_DUPLICATE_WAREHOUSE_NAME",
  ERR_DUPLICATE_LOCATION_CODE: "ERR_DUPLICATE_LOCATION_CODE",
  ERR_INVALID_WAREHOUSE: "ERR_INVALID_WAREHOUSE",
};
